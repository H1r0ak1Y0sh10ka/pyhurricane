...
tc_name          = "ideal"       # Typhoon name, you can set any name.
ex_name          = "ev_radius"   # Experiment name, you can set any name.
plot_kind        = 'timesiries'     # 'boxplot' or 'scatter'
param            = 'qv'          # 'distance' or 'qv', 'rh' ###or hgt

ex_kind          = "ensemble"   # Plot experiments, "individual" or "ensemble"
...
track_base_time_start = 72          # Trajectry start time in calculation [hour]
...
#case_names = ['CTL']
#legends    = ['CTL']
case_names = ['CTL','25km','50km','75km','100km','150km','200km']
legends = case_names
...
#####　can use this function for timeseries
traj.timeseries_trajectory_ens(input_trajectry_data_list, legends, track_base_time_start)
